...
const hero = "https://picsum.photos/seed/deploy-doctor-hero/1920/1080";
  ...
  return (
    <div className="page">
      <header className="hero full-bleed" style={{ "--hero": `url(${hero})` } as CSSProperties}>
        <nav className="nav"><p className="brand">Deploy Doctor</p><a className="btn btn-ghost" href="#mvp">MVP</a></nav>
        <div className="hero-content">
          <p className="eyebrow">devops</p>
          <h1>Validacao automatica de saude tecnica pos deploy.</h1>
          <p className="lead">Deploys sobem sem checklist tecnico completo.</p>
      ...
      <main className="shell">
        ...
        <section className="section split" data-reveal>
          ...
          <article><p className="label">Produto</p><h2>Plano por execucao com monitoramento continuo.</h2><p className="lead" style={{ color: "var(--muted)" }}>Base pronta para evoluir com autenticacao, banco e analytics.</p></article>
        </section>
      ...
      <footer className="footer"><p>Deploy Doctor</p><p>{new Date().getFullYear()} - Projeto com padrao senior.</p></footer>
    </div>
  );
}
